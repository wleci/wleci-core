        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
          ...
          >
            ...
            <h1 className="text-5xl xl:text-6xl font-bold mb-6 leading-tight">
              <span className="text-gray-900">{t("login.welcome_title")}</span>
              <br />
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-2">{t("login.form_title")}</h2>
            <p className="text-gray-600">{t("login.form_subtitle")}</p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <Button
              ...
              className="w-full bg-white hover:bg-gray-100 text-gray-900 font-medium py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center space-x-3 border border-gray-300"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-[1.02]"
            >
